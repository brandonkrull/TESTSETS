...
# CCSD(T)/CBS(aTQ5/e^(-x)) results from Feller and Peterson, JCP 110, 8384 (1999)
# CBS(aDTQ/e^(-x)) were used for H3COH, Si2H6, and H3CSH
# Energies in kcal/mol
mol_data = pd.read_csv('../ref/G2-1_CCSD_T.csv')
mol_data['CCSD(T)'] = mol_data['CCSD(T)'] * J_IN_CAL
...
for fun in funs:
    ...
    mol_data[fun + ' err.'] = mol_data[fun] - mol_data['CCSD(T)']
